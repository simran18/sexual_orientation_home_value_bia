...
dat <- read.csv(file = 'MechTurk_comp.csv', header=T)
...
write.csv(data.frame(dscore = dscore), "IAToutputMT_D1.csv")

dscore2[is.na(dscore2)] <- -99 
write.csv(data.frame(dscore2 = dscore2), "IAToutputMT_D2.csv")

dscore3[is.na(dscore3)] <- -99 
write.csv(data.frame(dscore3 = dscore3), "IAToutputMT_D3.csv")
